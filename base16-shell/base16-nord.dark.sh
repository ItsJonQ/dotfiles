...
color03="89/c0/d0" # Base 0A - Yellow
color04="78/9f/c0" # Base 0D - Blue
color05="d0/c1/fa" # Base 0E - Magenta
color06="89/c0/d0" # Base 0C - Cyan
color07="d9/dd/e7" # Base 05 - White
color08="68/75/90" # Base 03 - Bright Black
...
color18="32/38/45" # Base 01
color19="4a/53/66" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pj 4a5366 # selection color
