...
color07="4a/53/66" # Base 05 - White
...
color15="32/38/45" # Base 07 - Bright White
color16="f3/aa/67" # Base 09
color17="e4/8c/7d" # Base 0F
color18="e6/e9/ef" # Base 01
color19="d9/dd/e7" # Base 02
color20="68/75/90" # Base 04

color21="32/38/45" # Base 06


color_foreground="4a/53/66" # Base 05
color_background="ef/f1/f5" # Base 00

color_cursor="4a/53/66" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 4a5366 # forground
  printf $printf_template_custom Ph eff1f5 # background
  printf $printf_template_custom Pi 4a5366 # bold color
  printf $printf_template_custom Pj d9dde7 # selection color
  printf $printf_template_custom Pk 4a5366 # selected text color
  
  printf $printf_template_custom Pl 4a5366 # cursor
