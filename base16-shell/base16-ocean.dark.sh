...
color07="d1/d3/d7" # Base 05 - White
...
color19="3f/44/4f" # Base 02
color20="b3/b5/b9" # Base 04
color21="ea/ec/f0" # Base 06
color_foreground="d1/d3/d7" # Base 05
color_background="2b/30/3b" # Base 00
color_cursor="d1/d3/d7" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg d1d3d7 # forground
  printf $printf_template_custom Ph 2b303b # background
  printf $printf_template_custom Pi d1d3d7 # bold color
  printf $printf_template_custom Pj 3f444f # selection color
  printf $printf_template_custom Pk d1d3d7 # selected text color
  
  printf $printf_template_custom Pl d1d3d7 # cursor
