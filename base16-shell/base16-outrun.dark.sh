...
color18="0e/02/24" # Base 01
color19="15/03/35" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pj 150335 # selection color
