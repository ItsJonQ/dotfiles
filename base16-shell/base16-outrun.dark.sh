...
color02="2c/fd/a4" # Base 0B - Green
...
color08="41/35/48" # Base 03 - Bright Black
...
color18="16/0c/2d" # Base 01
color19="28/1c/39" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pj 281c39 # selection color
