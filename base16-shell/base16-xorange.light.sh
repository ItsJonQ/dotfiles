...
color00="ff/ab/40" # Base 00 - Black
...
color08="ff/ab/40" # Base 03 - Bright Black
...
color18="ff/ab/40" # Base 01
color19="ff/ab/40" # Base 02
...
color_background="ff/ab/40" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph ffab40 # background
  
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj ffab40 # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm ffab40 # cursor text
