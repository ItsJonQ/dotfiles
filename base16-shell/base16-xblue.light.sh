...
color00="40/c4/ff" # Base 00 - Black
...
color08="40/c4/ff" # Base 03 - Bright Black
...
color18="40/c4/ff" # Base 01
color19="40/c4/ff" # Base 02
...
color_background="40/c4/ff" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 40c4ff # background
  
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj 40c4ff # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm 40c4ff # cursor text
