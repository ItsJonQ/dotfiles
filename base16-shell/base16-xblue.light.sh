...
color00="00/8c/ff" # Base 00 - Black
...
color08="00/8c/ff" # Base 03 - Bright Black
...
color18="00/8c/ff" # Base 01
color19="00/8c/ff" # Base 02
...
color_background="00/8c/ff" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 008cff # background
  
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj 008cff # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm 008cff # cursor text
