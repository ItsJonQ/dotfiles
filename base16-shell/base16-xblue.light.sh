...
color00="32/a0/ff" # Base 00 - Black
...
color08="32/a0/ff" # Base 03 - Bright Black
...
color18="32/a0/ff" # Base 01
color19="32/a0/ff" # Base 02
...
color_background="32/a0/ff" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 32a0ff # background
  
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj 32a0ff # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm 32a0ff # cursor text
