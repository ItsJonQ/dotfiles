...
color07="25/25/26" # Base 05 - White
...
color15="1e/1e/1e" # Base 07 - Bright White
...
color21="1e/1e/1e" # Base 06


color_foreground="25/25/26" # Base 05
color_background="ff/ff/ff" # Base 00

color_cursor="25/25/26" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 252526 # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 252526 # bold color
  printf $printf_template_custom Pj dddddd # selection color
  printf $printf_template_custom Pk 252526 # selected text color
  printf $printf_template_custom Pl 252526 # cursor
