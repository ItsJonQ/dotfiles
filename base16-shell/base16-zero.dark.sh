...
color00="22/25/2b" # Base 00 - Black
...
color08="4d/53/61" # Base 03 - Bright Black
...
color18="25/28/2f" # Base 01
color19="36/3b/45" # Base 02
color20="b3/bd/d0" # Base 04
color21="e6/e9/ef" # Base 06
color_foreground="d9/dd/e7" # Base 05
color_background="22/25/2b" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 22252b # background
  printf $printf_template_custom Pi d9dde7 # bold color
  printf $printf_template_custom Pj 363b45 # selection color
  printf $printf_template_custom Pk d9dde7 # selected text color
  
  printf $printf_template_custom Pl d9dde7 # cursor
  
  
  printf $printf_template_custom Pm 22252b # cursor text
