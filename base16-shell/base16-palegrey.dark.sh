...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 303030 # background
  printf $printf_template_custom Pi dcdcdc # bold color
  printf $printf_template_custom Pj 4d4d4d # selection color
  printf $printf_template_custom Pk dcdcdc # selected text color
  
  printf $printf_template_custom Pl dcdcdc # cursor
  
  
  printf $printf_template_custom Pm 303030 # cursor text
