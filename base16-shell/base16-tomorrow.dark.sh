...
color07="c7/c9/cd" # Base 05 - White
color08="45/47/49" # Base 03 - Bright Black
...
color15="eb/ec/f0" # Base 07 - Bright White
color16="d0/87/70" # Base 09
color17="ab/79/67" # Base 0F
color18="22/24/26" # Base 01
color19="31/33/35" # Base 02
color20="b3/b5/b9" # Base 04
color21="db/dd/e1" # Base 06
color_foreground="c7/c9/cd" # Base 05
color_background="1d/1f/21" # Base 00
color_cursor="c7/c9/cd" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg c7c9cd # forground
  printf $printf_template_custom Ph 1d1f21 # background
  printf $printf_template_custom Pi c7c9cd # bold color
  printf $printf_template_custom Pj 313335 # selection color
  printf $printf_template_custom Pk c7c9cd # selected text color
  
  printf $printf_template_custom Pl c7c9cd # cursor
