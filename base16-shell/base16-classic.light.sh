...
color00="30/f1/5a" # Base 00 - Black
...
color08="30/f1/5a" # Base 03 - Bright Black
...
color18="30/f1/5a" # Base 01
color19="30/f1/5a" # Base 02
...
color_background="30/f1/5a" # Base 00

color_cursor="3b/3b/3b" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 30f15a # background
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj 30f15a # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm 30f15a # cursor text
