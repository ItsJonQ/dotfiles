...
color00="2f/ec/58" # Base 00 - Black
...
color08="2f/ec/58" # Base 03 - Bright Black
...
color18="2f/ec/58" # Base 01
color19="2f/ec/58" # Base 02
...
color_background="2f/ec/58" # Base 00

color_cursor="3a/3a/3a" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 2fec58 # background
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj 2fec58 # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm 2fec58 # cursor text
