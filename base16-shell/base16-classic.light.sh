...
color00="2d/e2/55" # Base 00 - Black
...
color08="2d/e2/55" # Base 03 - Bright Black
...
color15="1a/1a/1a" # Base 07 - Bright White
color16="2d/e2/55" # Base 09
color17="2d/e2/55" # Base 0F
color18="2d/e2/55" # Base 01
color19="2d/e2/55" # Base 02
...
color_background="2d/e2/55" # Base 00

color_cursor="37/37/37" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph 2de255 # background
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj 2de255 # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm 2de255 # cursor text
