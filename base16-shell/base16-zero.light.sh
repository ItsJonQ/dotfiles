...
color07="36/3b/45" # Base 05 - White
...
color15="25/28/2f" # Base 07 - Bright White
color16="d0/87/70" # Base 09
color17="e0/6c/75" # Base 0F
color18="e6/e9/ef" # Base 01
color19="d9/dd/e7" # Base 02
color20="4d/53/61" # Base 04

color21="25/28/2f" # Base 06


color_foreground="36/3b/45" # Base 05
color_background="ef/f1/f5" # Base 00

color_cursor="36/3b/45" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 363b45 # forground
  printf $printf_template_custom Ph eff1f5 # background
  printf $printf_template_custom Pi 363b45 # bold color
  printf $printf_template_custom Pj d9dde7 # selection color
  printf $printf_template_custom Pk 363b45 # selected text color
  
  printf $printf_template_custom Pl 363b45 # cursor
