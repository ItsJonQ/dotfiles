...
color00="e0/40/fb" # Base 00 - Black
...
color08="e0/40/fb" # Base 03 - Bright Black
...
color15="11/11/11" # Base 07 - Bright White
color16="e0/40/fb" # Base 09
color17="e0/40/fb" # Base 0F
color18="e0/40/fb" # Base 01
color19="e0/40/fb" # Base 02
...
color_background="e0/40/fb" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph e040fb # background
  
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj e040fb # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm e040fb # cursor text
