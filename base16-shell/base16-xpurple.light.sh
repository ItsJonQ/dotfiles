...
color00="f5/55/ff" # Base 00 - Black
...
color08="f5/55/ff" # Base 03 - Bright Black
...
color18="f5/55/ff" # Base 01
color19="f5/55/ff" # Base 02
...
color_background="f5/55/ff" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph f555ff # background
  
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj f555ff # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm f555ff # cursor text
