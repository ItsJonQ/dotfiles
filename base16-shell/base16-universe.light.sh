...
color00="f2/f0/eb" # Base 00 - Black
...
color08="cc/c5/b1" # Base 03 - Bright Black
...
color18="ec/e9/e2" # Base 01
color19="e4/e0/d5" # Base 02
...
color_background="f2/f0/eb" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph f2f0eb # background
  printf $printf_template_custom Pi 202633 # bold color
  printf $printf_template_custom Pj e4e0d5 # selection color
  printf $printf_template_custom Pk 202633 # selected text color
  
  printf $printf_template_custom Pl 202633 # cursor
  
  
  printf $printf_template_custom Pm f2f0eb # cursor text
