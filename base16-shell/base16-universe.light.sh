...
color00="f4/f0/eb" # Base 00 - Black
...
color08="d2/c2/ad" # Base 03 - Bright Black
...
color18="ef/e9/e2" # Base 01
color19="e7/df/d4" # Base 02
...
color_background="f4/f0/eb" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph f4f0eb # background
  printf $printf_template_custom Pi 202633 # bold color
  printf $printf_template_custom Pj e7dfd4 # selection color
  printf $printf_template_custom Pk 202633 # selected text color
  
  printf $printf_template_custom Pl 202633 # cursor
  
  
  printf $printf_template_custom Pm f4f0eb # cursor text
