...
color00="ff/ff/00" # Base 00 - Black
...
color08="ff/ff/00" # Base 03 - Bright Black
...
color_background="ff/ff/00" # Base 00
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Ph ffff00 # background
  
  printf $printf_template_custom Pi 000000 # bold color
  printf $printf_template_custom Pj ffff00 # selection color
  printf $printf_template_custom Pk 000000 # selected text color
  
  printf $printf_template_custom Pl 000000 # cursor
  
  
  printf $printf_template_custom Pm ffff00 # cursor text
