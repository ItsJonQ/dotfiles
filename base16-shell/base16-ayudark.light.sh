...
color07="12/16/1e" # Base 05 - White
...
color15="0c/0f/15" # Base 07 - Bright White
color16="f3/aa/67" # Base 09
color17="e4/8c/7d" # Base 0F
color18="e6/e9/ef" # Base 01
color19="d9/dd/e7" # Base 02
color20="19/20/2b" # Base 04

color21="0c/0f/15" # Base 06


color_foreground="12/16/1e" # Base 05
color_background="ef/f1/f5" # Base 00

color_cursor="12/16/1e" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 12161e # forground
  printf $printf_template_custom Ph eff1f5 # background
  printf $printf_template_custom Pi 12161e # bold color
  printf $printf_template_custom Pj d9dde7 # selection color
  printf $printf_template_custom Pk 12161e # selected text color
  
  printf $printf_template_custom Pl 12161e # cursor
