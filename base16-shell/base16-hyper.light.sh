...
color07="1d/22/23" # Base 05 - White
...
color15="12/15/16" # Base 07 - Bright White
...
color21="12/15/16" # Base 06


color_foreground="1d/22/23" # Base 05
color_background="d6/ff/10/4" # Base 00

color_cursor="1d/22/23" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 1d2223 # forground
  printf $printf_template_custom Ph d6ff104 # background
  printf $printf_template_custom Pi 1d2223 # bold color
  printf $printf_template_custom Pj badde1 # selection color
  printf $printf_template_custom Pk 1d2223 # selected text color
