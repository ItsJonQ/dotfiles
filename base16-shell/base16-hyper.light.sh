...
color07="21/21/21" # Base 05 - White
...
color_foreground="21/21/21" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 212121 # forground
  printf $printf_template_custom Ph fafafa # background
  printf $printf_template_custom Pi 212121 # bold color
  printf $printf_template_custom Pj d9d9d9 # selection color
  printf $printf_template_custom Pk 212121 # selected text color
