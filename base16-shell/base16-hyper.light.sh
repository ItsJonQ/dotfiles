...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 202020 # forground
  printf $printf_template_custom Ph f2f2f2 # background
  printf $printf_template_custom Pi 202020 # bold color
  printf $printf_template_custom Pj d2d2d2 # selection color
  printf $printf_template_custom Pk 202020 # selected text color
