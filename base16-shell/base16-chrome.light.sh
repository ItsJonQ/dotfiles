...
color07="33/35/3a" # Base 05 - White
...
color15="23/24/27" # Base 07 - Bright White
color16="f3/aa/67" # Base 09
color17="e4/8c/7d" # Base 0F
color18="e6/e9/ef" # Base 01
color19="d9/dd/e7" # Base 02
color20="48/4a/51" # Base 04

color21="23/24/27" # Base 06


color_foreground="33/35/3a" # Base 05
color_background="ef/f1/f5" # Base 00

color_cursor="33/35/3a" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 33353a # forground
  printf $printf_template_custom Ph eff1f5 # background
  printf $printf_template_custom Pi 33353a # bold color
  printf $printf_template_custom Pj d9dde7 # selection color
  printf $printf_template_custom Pk 33353a # selected text color
  
  printf $printf_template_custom Pl 33353a # cursor
