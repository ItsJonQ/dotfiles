...
color07="e4/e4/e4" # Base 05 - White
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg e4e4e4 # forground
  printf $printf_template_custom Ph 000000 # background
  printf $printf_template_custom Pi e4e4e4 # bold color
  printf $printf_template_custom Pj 262626 # selection color
  printf $printf_template_custom Pk e4e4e4 # selected text color
