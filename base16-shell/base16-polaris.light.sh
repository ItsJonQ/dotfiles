...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 272c56 # forground
  printf $printf_template_custom Ph eff1ff # background
  printf $printf_template_custom Pi 272c56 # bold color
