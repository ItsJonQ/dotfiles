...
color07="da/d4/c1" # Base 05 - White
...
color20="c6/c0/ad" # Base 04
color21="ee/e8/d5" # Base 06
color_foreground="da/d4/c1" # Base 05
color_background="00/2b/36" # Base 00
color_cursor="da/d4/c1" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg dad4c1 # forground
  printf $printf_template_custom Ph 002b36 # background
  printf $printf_template_custom Pi dad4c1 # bold color
  printf $printf_template_custom Pj 004556 # selection color
  printf $printf_template_custom Pk dad4c1 # selected text color
  
  printf $printf_template_custom Pl dad4c1 # cursor
