...
color07="00/3a/82" # Base 05 - White
...
color15="00/27/58" # Base 07 - Bright White
color16="ce/91/78" # Base 09
color17="c8/8c/be" # Base 0F
color18="f3/f3/f3" # Base 01
color19="dc/dc/dc" # Base 02
color20="00/51/b6" # Base 04

color21="00/27/58" # Base 06


color_foreground="00/3a/82" # Base 05
color_background="ff/ff/ff" # Base 00

color_cursor="00/3a/82" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 003a82 # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 003a82 # bold color
  printf $printf_template_custom Pj dcdcdc # selection color
  printf $printf_template_custom Pk 003a82 # selected text color
  
  printf $printf_template_custom Pl 003a82 # cursor
